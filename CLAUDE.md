...
deckBuilderModal и mulliganScreen (см. Backlog — Code выше) — ждём арт.
...
**Интерфейс:** скин окна декбилдера; фонарь Low-HP (висит здесь, пока не будет арта); иконка-
книга для лор-страницы.
