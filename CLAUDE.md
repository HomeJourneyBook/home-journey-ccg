...
**Szarg — опорный архетип (gtype:szg), "чистый" атакующий (без изменений с 2026-07-20):**
```
HP  = cost
ATK = cost + 1
   исключение: cost ≥ 4 И ≥ 2 доп.тегов сверх голых статов → ATK = cost (т.е. −1)
```
Живые числа: cost1 → 1/2, cost2 → 2/3, cost3 → 3/4, cost4 → 4/4 (2+ доп.тега) или 4/5 (0-1 доп.тег).
...
ATK = cost
```
Живые числа: cost2 → 2/2, cost3 → 3/3, cost4 → 4/4, cost5 → 5/5. **Существенно поднят
относительно предыдущей редакции** (была `max(1,cost−2)`, т.е. cost5 давал 5/3, теперь 5/5) —
по прямому запросу автора 2026-07-24; ATK теперь наравне со Szarg на том же cost, компенсация
за это — исключительно pierce (эффективный урон по бронированным/полным HP целям), не заниженные
голые статы.
...
```
Живые числа: cost2 → 4/1, cost3 → 5/2, cost4 → 6/3, cost5 → 7/3. **Переписана с нуля
...
- [ ] отредактировать Правила под версию 1.05
