...
- кнопки-фильтры сортировки — арт уже частично подключен (`sort_all/traveler/unique/ spell/world/artifact` × `1/H/2`, автор прислал 2026-07-08), но у самих кнопок пока нет
...
- [ ] Урон по базе Джита конкретно (не обобщённый `base_atack.wav`, который уже играет на
