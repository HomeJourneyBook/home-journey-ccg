...
| Блад | `rage` | 0.66 |
| Net | `invisible` | 0.66 |
| Пески | `vanguard` (при входе - не спит, действует сразу, см Tag System) | 0.66 |
...
- **Что дальше по крупному:** лор, правила, каталог — дизайн/вёрстка сделаны (Правила
  переделаны в книгу 2026-07-15, см. "Rules Book" секцию выше). **Остался лендинг** —
  см. "Лендинг" в Backlog — Art assets ниже: фон "комната внутри таверны", стол на
  переднем плане, кнопки лор/правила/каталог как часть стола, окно над кнопками
  ("close look on pages, notebook etc"), починка звуковых кнопок, музыка не должна
  останавливаться при закрытии страницы. Не проверял, что из этого списка уже могло
  быть сделано в сессиях, не отражённых здесь отдельной секцией — стоит сверить с
  автором перед началом.
...
- [x] ~~Лор-страница, Правила, Каталог — доработка дизайна и вёрстки.~~ Правила
  переделаны в книгу 2026-07-15 (см. "Rules Book" секцию и журнал сессии выше). Лор и
  Каталог — автор подтвердил дизайн сделанным в предыдущих сессиях (не задокументировано
  отдельной секцией здесь — если в них ещё будут правки, стоит завести такую же секцию,
  как у Rules Book, вместо точечных заметок в журнале).
