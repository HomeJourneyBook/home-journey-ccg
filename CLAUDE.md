...
**Финальный размер Classic-колоды (проверено прогоном `_composeDeckList()`):** 27 существ +
5 легендарок + 26 спеллов + 2 мира + 2 артефакта = **62 карты/фракция** (было 73). Больше, чем
изначально прикидывали (~48-52), из-за 4 новых существ и того, что 26 спеллов всё ещё
существенно — но заметно компактнее исходных 73, и полностью укладывается в `groupSize:5` без
правки других частей конфига.
