...
|Mode     |What happens                                                                                                                                                                                                                                                                                       |
|---------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
|`classic`|Fixed 1st-edition starter — `buildDeck(f,'classic')` builds all 6 archetypes (27 creatures/faction) + all 5 legendaries + per-spell copy counts (`SPELL_COPIES`, 26 spells/faction) + 2 worlds + 2 artifacts = 62 cards/faction. Themed 2026-07-18 as Tea=Burn/Jeet=Fear — see CLAUDE.md "Рефактор классик-колоды под тему Врат" for the full rationale/history. Still expected to keep changing size as balance testing continues — see `DECK_CONFIGS.classic`/`SPELL_COPIES` in deck.js.|
