...
- Szarg/Dreegan/Mechird/Umbasir — паттерны ещё не определены, придумаем по мере того, как
  автор дойдёт до сожжённых карт этих архетипов (Szarg: протяжная гласная типа "Rooogha",
  озвучено автором как направление, конкретный банк слогов ещё не зафиксирован).
...
- **To the Moon with DHD** → «Game of Market» — при каждой атаке 50/50: либо +2 доп.урона,
  либо −2 HP себе.
...
Без назначения: Optical Dope, DD's Signature, MonoMEK, Nanas from SMB.
