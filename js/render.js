...
function reorderZones(){
  ...
  <span class="statbar-core">
    ...
    <span class="stat stat-ess-box ${oppK}-ess-box"><img src="./img/ess.png" class="stat-icon"> <span class="ess-val" id="${oppK}Ess">${oppP.ess}</span></span>
  </span>
  ...
  <span class="statbar-core">
    ...
    <span class="stat stat-ess-box ${playerK}-ess-box"><img src="./img/ess.png" class="stat-icon"> <span class="ess-val" id="${playerK}Ess">${playerP.ess}</span></span>
  </span>
