...
function mkSmallEl(card){
  ...
  if(G.phase==='shardTarget'&&card.f!==G.turn&&!card.spell&&!card.world&&!card.artifact&&!hasTag(card,'ward')&&isSpellTargetable(card,G[card.f].field)) d.classList.add('targetable','aim-target');
  if(G.phase==='boltTarget'&&card.f!==G.turn&&!card.spell&&!card.world&&!card.artifact&&!hasTag(card,'ward')&&isSpellTargetable(card,G[card.f].field)) d.classList.add('targetable','aim-target');
  if(G.phase==='spellDmgTarget'&&card.f!==G.turn&&!card.spell&&!card.world&&!card.artifact&&!hasTag(card,'ward')&&isSpellTargetable(card,G[card.f].field)) d.classList.add('targetable','aim-target');
  ...
  if(G.phase==='spellDmgTrampleTarget'&&card.f!==G.turn&&!card.spell&&!card.world&&!card.artifact&&!hasTag(card,'ward')&&isSpellTargetable(card,G[card.f].field)) d.classList.add('targetable','aim-target');
  ...
  if(G.phase==='spellExecuteHalfTarget'&&card.f!==G.turn&&!card.spell&&!card.world&&!card.artifact&&!hasTag(card,'ward')&&isSpellTargetable(card,G[card.f].field)) d.classList.add('targetable','aim-target');
