  ...
  for(const a of abs){
    switch(a.effect){
      ...
      case 'random_spread':
        ...
        // 2026-07-24 — баг, автор поймал живьём, и уточнение 2026-07-24: пул целей
        // ЛЮБОЙ вражеский, включая Ward/невидимых — это честная случайность, урон МОЖЕТ
        // впустую уйти в Ward (сгорит целиком) или невидимую цель, это ожидаемо и не баг.
