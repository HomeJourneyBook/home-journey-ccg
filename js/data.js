...
const DEFS = {
  ...
  t_trvl34_w:   {name:"TRAVELER #34",   cost:3,hp:5,atk:4,art:"🦈", img:"34.png",   f:"tea",tags:["regen","gtype:szg"],           ab:"Squad: +1 maxHP."},
  t_trvl434_w:  {name:"TRAVELER #434",  cost:4,hp:4,atk:5,art:"🦈", img:"434.png",  f:"tea",tags:["fear","incarnation:4","gtype:szg"],            ab:"Squad: +1 maxHP."},
  t_trvl734_w:  {name:"TRAVELER #734",  cost:3,hp:5,atk:3,art:"🦈", img:"734.png",  f:"tea",tags:["necrophage","gtype:szg"],            ab:"Squad: +1 maxHP."},
  ...
  t_trvl398_w:  {name:"TRAVELER #398",  cost:3,hp:3,atk:1,art:"👁️", img:"398.png",  f:"tea",tags:["heal:1","vanguard","untamed","armor:1","gtype:orb"],         ab:"Active: Heal 1 HP. Squad: Heal 2."},
  ...
  // Dreegan Tea
  t_trvl1_w:    {name:"TRAVELER #1",    cost:3,hp:6,atk:1,art:"🌳", img:"1.png",    f:"tea",tags:["provoke","enter_heal:2","gtype:drg"],                   ab:"On play: Heal 2 HP to wounded allies. Squad: +1 Armor."},
  t_trvl31_w:   {name:"TRAVELER #31",   cost:5,hp:8,atk:3,art:"🌳", img:"31.png",   f:"tea",tags:["provoke","armor:1","burn","gtype:drg"],             ab:"Squad: +1 Armor."},
  t_trvl892_w:  {name:"TRAVELER #892",  cost:4,hp:6,atk:2,art:"🌳", img:"892.png",  f:"tea",tags:["provoke","regen","armor:1","gtype:drg"],            ab:"Squad: +1 Armor."},
  t_trvl14_w:   {name:"TRAVELER #14",   cost:3,hp:5,atk:1,art:"🌳", img:"14.png",   f:"tea",tags:["provoke","armor:1","gtype:drg"],                   ab:"Squad: +1 Armor."},

  // Umbasir Tea
    t_trvl583_w:    {name:"TRAVELER #583",  cost:3,hp:4,atk:2,art:"🌀", img:"583.png",  f:"tea",tags:["bolt:1","regen","enter_heal:2","gtype:umb"],              ab:"On play: Heal 2 HP to wounded allies. Active: Bolt 1 dmg. Squad: Bolt 2 dmg."},
     ...
     t_trvl52_w:    {name:"TRAVELER #52",   cost:1,hp:1,atk:0,art:"🌀", img:"52.png",   f:"tea",tags:["bolt:1","gtype:umb"],                     ab:"Active: Bolt 1 dmg. Squad: Bolt 2 dmg."},
      t_trvl6_w:    {name:"TRAVELER #6",    cost:3,hp:5,atk:1,art:"🌀", img:"6.png",    f:"tea",tags:["bolt:1","enter_draw:1","gtype:umb"],                     ab:"On play: Draw 1 card. Active: Bolt 1 dmg. Squad: Bolt 2 dmg."},

  // Mechird Tea
  t_trvl38_w:   {name:"TRAVELER #38",   cost:3,hp:4,atk:2,art:"🤖", img:"38.png",   f:"tea",tags:["pierce","rage","gtype:mch"],              ab:"Squad: +1 ATK."},
  t_trvl18_w:   {name:"TRAVELER #18",   cost:2,hp:2,atk:2,art:"🤖", img:"18.png",   f:"tea",tags:["pierce","gtype:mch"],                    ab:"Squad: +1 ATK."},
  t_trvl35_w:   {name:"TRAVELER #35",   cost:4,hp:6,atk:3,art:"🤖", img:"35.png",   f:"tea",tags:["pierce","armor:1","gtype:mch"],                    ab:"Squad: +1 ATK."},
  t_trvl11_w:   {name:"TRAVELER #11",   cost:4,hp:5,atk:3,art:"🤖", img:"11.png",   f:"tea",tags:["pierce","armor:1","enter_heal:2","gtype:mch"],                    ab:"On play: Heal 2 HP to wounded allies. Squad: +1 ATK."},

  // Xuiqtr Tea
    t_trvl187_w:    {name:"TRAVELER #187",  cost:5,hp:8,atk:4,art:"🐙", img:"187.png",  f:"tea",tags:["provoke","armor:1","untamed","gtype:xui"],                   ab:"Squad: +1 ATK."},
    t_trvl704_w:    {name:"TRAVELER #704",  cost:4,hp:5,atk:2,art:"🐙", img:"704.png",  f:"tea",tags:["provoke","fear","shield","gtype:xui"],             ab:"Solana Shield. Squad: +1 ATK."},
  ...
  // ── TEA LEGENDARIES ─────────────────────────────────────────────
  t_tean:      {name:"TEANTIST",   cost:5,hp:7,atk:2,art:"🧙", img:"002_Teantist.png", f:"tea",tags:["unique","draw:1","ward"],            ab:"On turn: Draw 1 card.",unique:true},
  t_aslex:     {name:"ASLEX",      cost:5,hp:8,atk:3,art:"🍵", img:"008_Aslex.png",    f:"tea",tags:["unique","aura:maxhp:1"],      ab:"Aura: +1 maxHP.",unique:true},
  t_tuborg:    {name:"TUBORG",     cost:5,hp:7,atk:2,art:"👑", img:"011_Tuborg.png",   f:"tea",tags:["unique","aura:atk:1","untamed","armor:1"],       ab:"Aura: +1 ATK.",unique:true},
  t_faeron:    {name:"FAERON",     cost:4,hp:6,atk:2,art:"🔥", img:"010_Faeron.png",   f:"tea",tags:["unique","burn","on_play_creature:1","untamed"], ab:"After each card play: Heal base 1 HP.",unique:true},
  t_nab:       {name:"NABUNAGI",   cost:6,hp:8,atk:2,art:"⛩️", img:"009_Oda.png",     f:"tea",tags:["unique","bushido","armor:1","ward"], ab:"\"Bushido\": ALL attacks must target him. Ward.",unique:true},
  ...
  j_trvl551_w: {name:"TRAVELER #551", cost:3,hp:5,atk:3,art:"🦈", img:"551.png", f:"jeet",tags:["incarnation:4","gtype:szg"],      ab:"Squad: +1 maxHP."},
  ...
  j_trvl454_w: {name:"TRAVELER #454", cost:3,hp:4,atk:2,art:"👁️", img:"454.png", f:"jeet",tags:["heal:1","regen","armor:1","gtype:orb"],           ab:"Active: Heal 1 HP. Squad: Heal 2."},
  ...
  // Dreegan Jeet
  j_trvl36_w:   {name:"TRAVELER #36",   cost:3,hp:5,atk:2,art:"🌳", img:"36.png",   f:"jeet",tags:["provoke","untamed","gtype:drg"],               ab:"Squad: +1 Armor."},
  j_trvl41_w:   {name:"TRAVELER #41",   cost:2,hp:3,atk:1,art:"🌳", img:"41.png",   f:"jeet",tags:["provoke","gtype:drg"],               ab:"Squad: +1 Armor."},
  j_trvl1015_w: {name:"TRAVELER #1015", cost:4,hp:7,atk:3,art:"🌳", img:"1015.png", f:"jeet",tags:["provoke","regen","gtype:drg"],        ab:"Squad: +1 Armor."},
  j_trvl859_w:  {name:"TRAVELER #859",  cost:4,hp:6,atk:1,art:"🌳", img:"859.png",  f:"jeet",tags:["provoke","fear","vanguard","gtype:drg"],ab:"Squad: +1 Armor."},
  j_trvl775_w:  {name:"TRAVELER #775",  cost:4,hp:6,atk:3,art:"🌳", img:"775.png",  f:"jeet",tags:["provoke","vampiric","gtype:drg"],ab:"Squad: +1 Armor."},

  // Umbasir Jeet
    j_trvl550_w:    {name:"TRAVELER #550",  cost:4,hp:5,atk:2,art:"🌀", img:"550.png",  f:"jeet",tags:["bolt:1","fear","taunt_break","gtype:umb"],           ab:"Active: Bolt 1 dmg. Squad: Bolt 2 dmg."},
     ...
     j_trvl20_w:    {name:"TRAVELER #20",   cost:3,hp:4,atk:1,art:"🌀", img:"20.png",   f:"jeet",tags:["bolt:1","vanguard","untamed","gtype:umb"],        ab:"Active: Bolt 1 dmg. Squad: Bolt 2 dmg."},

  // Mechird Jeet
  j_trvl22_w:   {name:"TRAVELER #22",   cost:3,hp:4,atk:3,art:"🤖", img:"22.png",   f:"jeet",tags:["pierce","untamed","gtype:mch"],                 ab:"Squad: +1 ATK."},
  j_trvl724_w:  {name:"TRAVELER #724",  cost:2,hp:2,atk:2,art:"🤖", img:"724.png",  f:"jeet",tags:["pierce","gtype:mch"],                 ab:"Squad: +1 ATK."},
  j_trvl921_w:  {name:"TRAVELER #921",  cost:5,hp:7,atk:4,art:"🤖", img:"921.png",  f:"jeet",tags:["pierce","armor:1","burn","gtype:mch"],           ab:"Squad: +1 ATK."},
  ...
  // Xuiqtr Jeet
    j_trvl579_w:    {name:"TRAVELER #579",  cost:4,hp:4,atk:2,art:"🐙", img:"579.png",  f:"jeet",tags:["provoke","fear","gtype:xui"],          ab:"Squad: +1 ATK."},
    j_trvl972_w:    {name:"TRAVELER #972",  cost:3,hp:4,atk:2,art:"🐙", img:"972.png",  f:"jeet",tags:["provoke","burn","gtype:xui"],          ab:"Squad: +1 ATK."},
     ...
     j_trvl37_w:    {name:"TRAVELER #37",   cost:5,hp:8,atk:3,art:"🐙", img:"37.png",   f:"jeet",tags:["provoke","armor:1","gtype:xui"],                 ab:"Squad: +1 ATK."},
  ...
  j_ryv:       {name:"RYVLEN",      cost:4,hp:5,atk:2,art:"🎭", img:"007_Ryvlen.png",      f:"jeet",tags:["unique","invisible","fear","draw_attack:1"],        ab:"On attack: Draw 1 card.",unique:true},
  j_mal:       {name:"ABYSSWALKER", cost:5,hp:7,atk:2,art:"🗡️", img:"001_Abysswalker.png", f:"jeet",tags:["unique","armor:1","aura:armor:1"],          ab:"Aura: +1 Armor.",unique:true},
  j_phleg:     {name:"PHLEGMOR",    cost:6,hp:9,atk:1,art:"💀", img:"005_Phelgmor.png",    f:"jeet",tags:["unique","raise:1","incarnation:2"],                     ab:"On turn: Raise top graveyard card at 1 HP.",unique:true},
