const DEFS = {
  ...
  t_trvl398_w:  {name:"TRAVELER #398",  cost:2,hp:2,atk:1,art:"👁️", img:"398.png",  f:"tea",tags:["heal:1","vanguard","gtype:orb"],         ab:"Active: Heal 1 HP. Squad: Heal 2."},
  t_trvl433_w:  {name:"TRAVELER #433",  cost:1,hp:2,atk:1,art:"👁️", img:"433.png",  f:"tea",tags:["heal:1","gtype:orb"],                   ab:"Active: Heal 1 HP. Squad: Heal 2."},
  t_trvl1034_w: {name:"TRAVELER #1034", cost:1,hp:2,atk:1,art:"👁️", img:"1034.png", f:"tea",tags:["heal:1","gtype:orb"],                   ab:"Active: Heal 1 HP. Squad: Heal 2."},
  ...
  // Umbasir Tea
  t_trvl583_w:  {name:"TRAVELER #583",  cost:3,hp:2,atk:1,art:"🌀", img:"583.png",  f:"tea",tags:["aoe:1","regen","gtype:umb"],              ab:"Active: AOE 1 dmg. Squad: AOE 2 dmg."},
  t_trvl2_w:    {name:"TRAVELER #2",    cost:2,hp:2,atk:1,art:"🌀", img:"2.png",    f:"tea",tags:["aoe:1","gtype:umb"],                     ab:"Active: AOE 1 dmg. Squad: AOE 2 dmg."},
  ...
  t_trvl18_w:   {name:"TRAVELER #18",   cost:2,hp:3,atk:1,art:"🤖", img:"18.png",   f:"tea",tags:["pierce","gtype:mch"],                    ab:"Squad: +1 ATK."},
  t_trvl35_w:   {name:"TRAVELER #35",   cost:2,hp:3,atk:1,art:"🤖", img:"35.png",   f:"tea",tags:["pierce","gtype:mch"],                    ab:"Squad: +1 ATK."},
  ...
  j_trvl429_w: {name:"TRAVELER #429", cost:1,hp:2,atk:1,art:"👁️", img:"429.png", f:"jeet",tags:["heal:1","gtype:orb"],                  ab:"Active: Heal 1 HP. Squad: Heal 2."},
  j_trvl454_w: {name:"TRAVELER #454", cost:2,hp:2,atk:1,art:"👁️", img:"454.png", f:"jeet",tags:["heal:1","regen","gtype:orb"],           ab:"Active: Heal 1 HP. Squad: Heal 2."},
  ...
  j_trvl20_w:   {name:"TRAVELER #20",   cost:3,hp:2,atk:1,art:"🌀", img:"20.png",   f:"jeet",tags:["aoe:1","vanguard","gtype:umb"],        ab:"Active: AOE 1 dmg. Squad: AOE 2 dmg."},

  // Mechird Jeet
  j_trvl22_w:   {name:"TRAVELER #22",   cost:2,hp:3,atk:1,art:"🤖", img:"22.png",   f:"jeet",tags:["pierce","gtype:mch"],                 ab:"Squad: +1 ATK."},
  j_trvl724_w:  {name:"TRAVELER #724",  cost:2,hp:3,atk:1,art:"🤖", img:"724.png",  f:"jeet",tags:["pierce","gtype:mch"],                 ab:"Squad: +1 ATK."},
  j_trvl921_w:  {name:"TRAVELER #921",  cost:4,hp:3,atk:1,art:"🤖", img:"921.png",  f:"jeet",tags:["pierce","burn","gtype:mch"],           ab:"Squad: +1 ATK."},
  j_trvl804_w:  {name:"TRAVELER #804",  cost:4,hp:3,atk:1,art:"🤖", img:"804.png",  f:"jeet",tags:["pierce","regen","gtype:mch"],          ab:"Squad: +1 ATK."},

  // Xuiqtr Jeet
  j_trvl579_w:  {name:"TRAVELER #579",  cost:4,hp:4,atk:1,art:"🐙", img:"579.png",  f:"jeet",tags:["regen:1","fear","gtype:xui"],          ab:"Squad: Regen 2."},
  j_trvl972_w:  {name:"TRAVELER #972",  cost:4,hp:5,atk:1,art:"🐙", img:"972.png",  f:"jeet",tags:["regen:1","burn","gtype:xui"],          ab:"Squad: Regen 2."},
