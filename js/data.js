...
const DEFS = {
  ...
  t_sp18:      {name:"SCATTERSHOT",  cost:3,hp:0,atk:0,art:"💥", img:"1_Scattershot.png", f:"tea",tags:["spell","spell_random_spread:3"], ab:"3 random damage split across enemy creatures and their base.",spell:true}, // база теперь тоже в пуле случайных целей (2026-07-24, по прямому запросу автора) — см. case 'random_spread' в abilities.js
  ...
  t_sp25:      {name:"TEMPEST", cost:4,hp:0,atk:0,art:"🌪️", img:"1_Tempest.png", f:"tea",tags:["spell","spell_bounce_target"], ab:"Return 1 target creature (either side) to hand.",spell:true}, // cost 2→4 (2026-07-24, по прямому запросу автора) — баунс без ограничений на цель дёшево смотрелся за 2. Держит СТАРУЮ механику GUST (spell_bounce_target, любая сторона), выделена в отдельную карту при редизайне GUST в ally-only. Только в ростере, не в Classic
  ...
  j_sp18:      {name:"SHRAPNEL",      cost:3,hp:0,atk:0,art:"💥", img:"1_Shrapnel.png", f:"jeet",tags:["spell","spell_random_spread:3"], ab:"3 random damage split across enemy creatures and their base.",spell:true}, // база теперь тоже в пуле (2026-07-24, по прямому запросу автора) — зеркало SCATTERSHOT
  ...
  j_sp22:      {name:"EXTINCTION",      cost:7,hp:0,atk:0,art:"☄️", img:"1_Extinction.png", f:"jeet",tags:["spell","spell_destroy_all_enemies"], ab:"Destroy ALL creatures — yours too. Draw a card for each of your own creatures destroyed this way.",spell:true}, // РЕДИЗАЙН (2026-07-24, по прямому запросу автора) — зеркало CATACLYSM
  ...
  j_sp25:      {name:"MAELSTROM", cost:4,hp:0,atk:0,art:"🌪️", img:"1_Maelstrom.png", f:"jeet",tags:["spell","spell_bounce_target"], ab:"Return 1 target creature (either side) to hand.",spell:true}, // cost 2→4 (2026-07-24, по прямому запросу автора) — зеркало TEMPEST (t_sp25)
