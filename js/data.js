...
const DEFS = {
  ...
  // Dreegan Tea
  t_trvl1_w:    {name:"TRAVELER #1",    cost:3,hp:6,atk:1,art:"🌳", img:"1.png",    f:"tea",tags:["provoke","death_heal:4","gtype:drg"],                   ab:"On death, heal a random wounded ally 4. Squad +1 Armor."}, // enter_heal:2→death_heal:4 (2026-07-26, по прямому запросу автора — Бамбук: не вход, а смерть; не все раненые, а один случайный)
  ...
  // Umbasir Tea (HP ребаланс 2026-07-20 — см. комментарий у Orbiton Tea выше)
    t_trvl583_w:    {name:"TRAVELER #583",  cost:4,hp:4,atk:2,art:"🌀", img:"583.png",  f:"tea",tags:["bolt:1","regen","death_heal:4","gtype:umb"],              ab:"On death, heal a random wounded ally 4. Active Bolt 1. Squad Bolt 2."}, // enter_heal:2→death_heal:4 (2026-07-26, перепривязка Бамбука)
  ...
  t_trvl699_w:   {name:"TRAVELER #699",   cost:4,hp:4,atk:4,art:"🤖", img:"699.png",   f:"tea",tags:["pierce","taunt_break","untamed","gtype:mch"],                    ab:"Squad +1 ATK."}, // новая карта (2026-07-24, по прямому запросу автора) — cost4 Mechird, 2 доп.тега (taunt_break+untamed), статы по образцу пиров #663/#320 (cost4, 2 доп.тега = hp4/atk3)
  t_trvl495_w:   {name:"TRAVELER #495",   cost:4,hp:4,atk:4,art:"🤖", img:"495.png",   f:"tea",tags:["pierce","ward","death_heal:4","gtype:mch"],                    ab:"On death, heal a random wounded ally 4. Squad +1 ATK."}, // новая карта (2026-07-24, по прямому запросу автора) — cost4 Mechird, 2 доп.тега (ward+enter_heal:2), статы по образцу пиров #663/#320. enter_heal:2→death_heal:4 (2026-07-26, перепривязка Бамбука)
  ...
  t_trvl11_w:   {name:"TRAVELER #11",   cost:3,hp:3,atk:3,art:"🤖", img:"11.png",   f:"tea",tags:["pierce","death_heal:4","gtype:mch"],                    ab:"On death, heal a random wounded ally 4. Squad +1 ATK."}, // enter_heal:2→death_heal:4 (2026-07-26, перепривязка Бамбука)
  ...
  j_trvl128_w:  {name:"TRAVELER #128",  cost:5,hp:5,atk:5,art:"🤖", img:"128.png",  f:"jeet",tags:["pierce","atk_vs_feared:1","incarnation:4","gtype:mch"],           ab:"Squad +1 ATK."}, // cost 6→5 (2026-07-24, по прямому запросу автора) — hp/atk не менялись, уже совпадали с экстраполяцией cost5/2-тега (cost4:hp4/atk3 → cost5:hp5/atk4, см. #663/#320)
  ...
  t_trvl420_w: {name:"TRAVELER #420", cost:3,hp:3,atk:1,art:"👁️", img:"420.png", f:"tea",tags:["heal:2","death_heal:4","gtype:orb"],            ab:"On death, heal a random wounded ally 4. Active Heal 2 and Clean. Squad Heal 4."}, // перенесён Jeet→Tea (2026-07-24, по прямому запросу автора); cost3 Orbiton, 1 доп.тег (enter_heal:2), статы по образцу пира #10 (cost3, 1 доп.тег = hp3/atk1). enter_heal:2→death_heal:4 (2026-07-26, перепривязка Бамбука)
  ...
  // Umbasir Jeet (HP ребаланс 2026-07-20 — см. комментарий у Orbiton Tea выше)
    j_trvl550_w:    {name:"TRAVELER #550",  cost:4,hp:4,atk:2,art:"🌀", img:"550.png",  f:"jeet",tags:["bolt:1","fear","taunt_break","gtype:umb"],           ab:"Active Bolt 1. Squad Bolt 2."},
  ...
  j_trvl663_w:  {name:"TRAVELER #663",  cost:4,hp:4,atk:4,art:"🤖", img:"663.png",  f:"jeet",tags:["pierce","fear","death_heal:4","gtype:mch"],          ab:"On death, heal a random wounded ally 4. Squad +1 ATK."}, // enter_heal:2→death_heal:4 (2026-07-26, перепривязка Бамбука)
  j_trvl320_w:  {name:"TRAVELER #320",  cost:4,hp:4,atk:4,art:"🤖", img:"320.png",  f:"jeet",tags:["pierce","necrophage","untamed","gtype:mch"],          ab:"Squad +1 ATK."},
