...
const DEFS = {
  ...
  // Orbiton Tea
  t_trvl10_w:   {name:"TRAVELER #10",   cost:3,hp:5,atk:1,art:"👁️", img:"10.png",   f:"tea",tags:["heal:1","burn","gtype:orb"],             ab:"Active: Heal 1 HP. Squad: Heal 2."},
  ...
  t_trvl31_w:   {name:"TRAVELER #31",   cost:4,hp:5,atk:2,art:"🌳", img:"31.png",   f:"tea",tags:["provoke","burn","gtype:drg"],             ab:"Squad: +1 Armor."},
  t_trvl892_w:  {name:"TRAVELER #892",  cost:4,hp:5,atk:2,art:"🌳", img:"892.png",  f:"tea",tags:["provoke","regen","gtype:drg"],            ab:"Squad: +1 Armor."},
  t_trvl14_w:   {name:"TRAVELER #14",   cost:3,hp:4,atk:1,art:"🌳", img:"14.png",   f:"tea",tags:["provoke","gtype:drg"],                   ab:"Squad: +1 Armor."},

  // Umbasir Tea
  t_trvl583_w:  {name:"TRAVELER #583",  cost:3,hp:4,atk:1,art:"🌀", img:"583.png",  f:"tea",tags:["aoe:1","regen","gtype:umb"],              ab:"Active: AOE 1 dmg. Squad: AOE 2 dmg."},
  t_trvl2_w:    {name:"TRAVELER #2",    cost:3,hp:4,atk:1,art:"🌀", img:"2.png",    f:"tea",tags:["aoe:1","gtype:umb","untamed"],                     ab:"Active: AOE 1 dmg. Squad: AOE 2 dmg."},
  t_trvl52_w:   {name:"TRAVELER #52",   cost:2,hp:2,atk:1,art:"🌀", img:"52.png",   f:"tea",tags:["aoe:1","gtype:umb"],                     ab:"Active: AOE 1 dmg. Squad: AOE 2 dmg."},
  t_trvl6_w:    {name:"TRAVELER #6",    cost:2,hp:2,atk:1,art:"🌀", img:"6.png",    f:"tea",tags:["aoe:1","gtype:umb"],                     ab:"Active: AOE 1 dmg. Squad: AOE 2 dmg."},
  ...
  // Xuiqtr Tea
  t_trvl187_w:  {name:"TRAVELER #187",  cost:4,hp:5,atk:2,art:"🐙", img:"187.png",  f:"tea",tags:["provoke","gtype:xui","untamed"],                   ab:"Squad: Regen 2."},
  t_trvl704_w:  {name:"TRAVELER #704",  cost:4,hp:5,atk:2,art:"🐙", img:"704.png",  f:"tea",tags:["provoke","fear","gtype:xui"],             ab:"Squad: Regen 2."},
  t_trvl26_w:   {name:"TRAVELER #26",   cost:3,hp:4,atk:1,art:"🐙", img:"26.png",   f:"tea",tags:["provoke","gtype:xui"],            ab:"Squad: Regen 2."},
  ...
  j_trvl57_w:  {name:"TRAVELER #57",  cost:3,hp:2,atk:4,art:"🦈", img:"57.png",  f:"jeet",tags:["vanguard","burn","gtype:szg"],           ab:"Squad: +1 maxHP."},
  j_trvl551_w: {name:"TRAVELER #551", cost:3,hp:2,atk:4,art:"🦈", img:"551.png", f:"jeet",tags:["vanguard","gtype:szg","incarnation:4"],      ab:"Squad: +1 maxHP. Incarnation 4."},
  ...
  // Dreegan Jeet
  j_trvl36_w:   {name:"TRAVELER #36",   cost:4,hp:5,atk:2,art:"🌳", img:"36.png",   f:"jeet",tags:["provoke","gtype:drg","untamed"],               ab:"Squad: +1 Armor."},
  j_trvl41_w:   {name:"TRAVELER #41",   cost:3,hp:4,atk:1,art:"🌳", img:"41.png",   f:"jeet",tags:["provoke","gtype:drg"],               ab:"Squad: +1 Armor."},
  j_trvl1015_w: {name:"TRAVELER #1015", cost:4,hp:5,atk:2,art:"🌳", img:"1015.png", f:"jeet",tags:["provoke","regen","gtype:drg"],        ab:"Squad: +1 Armor."},
  j_trvl859_w:  {name:"TRAVELER #859",  cost:5,hp:5,atk:3,art:"🌳", img:"859.png",  f:"jeet",tags:["provoke","fear","vanguard","gtype:drg"],ab:"Squad: +1 Armor."},

  // Umbasir Jeet
  j_trvl550_w:  {name:"TRAVELER #550",  cost:3,hp:4,atk:1,art:"🌀", img:"550.png",  f:"jeet",tags:["aoe:1","fear","gtype:umb"],           ab:"Active: AOE 1 dmg. Squad: AOE 2 dmg."},
  j_trvl53_w:   {name:"TRAVELER #53",   cost:2,hp:2,atk:1,art:"🌀", img:"53.png",   f:"jeet",tags:["aoe:1","gtype:umb"],                  ab:"Active: AOE 1 dmg. Squad: AOE 2 dmg."},
  j_trvl54_w:   {name:"TRAVELER #54",   cost:2,hp:2,atk:1,art:"🌀", img:"54.png",   f:"jeet",tags:["aoe:1","gtype:umb"],                  ab:"Active: AOE 1 dmg. Squad: AOE 2 dmg."},
  j_trvl20_w:   {name:"TRAVELER #20",   cost:4,hp:5,atk:1,art:"🌀", img:"20.png",   f:"jeet",tags:["aoe:1","vanguard","gtype:umb","untamed"],        ab:"Active: AOE 1 dmg. Squad: AOE 2 dmg."},

  // Mechird Jeet
  j_trvl22_w:   {name:"TRAVELER #22",   cost:3,hp:2,atk:4,art:"🤖", img:"22.png",   f:"jeet",tags:["pierce","gtype:mch","untamed"],                 ab:"Squad: +1 ATK."},
  ...
  j_trvl804_w:  {name:"TRAVELER #804",  cost:3,hp:2,atk:4,art:"🤖", img:"804.png",  f:"jeet",tags:["pierce","regen","gtype:mch"],          ab:"Squad: +1 ATK."},

  // Xuiqtr Jeet
  j_trvl579_w:  {name:"TRAVELER #579",  cost:4,hp:5,atk:2,art:"🐙", img:"579.png",  f:"jeet",tags:["provoke","fear","gtype:xui"],          ab:"Squad: Regen 2."},
  j_trvl972_w:  {name:"TRAVELER #972",  cost:4,hp:5,atk:2,art:"🐙", img:"972.png",  f:"jeet",tags:["provoke","burn","gtype:xui"],          ab:"Squad: Regen 2."},
  ...
  j_phleg:     {name:"PHLEGMOR",    cost:6,hp:7,atk:1,art:"💀", img:"005_Phelgmor.png",    f:"jeet",tags:["unique","raise:1","incarnation:3"],                     ab:"On turn: Raise top graveyard card at 1 HP. Incarnation 3.",unique:true},
