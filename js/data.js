...
const DEFS = {
  ...
  t_trvl619_w:  {name:"TRAVELER #619",  cost:3,hp:3,atk:1,art:"👁️", img:"619.png",  f:"tea",tags:["heal:3","enter_draw:1","gtype:orb"],   ab:"On play Draw 1. Active Heal 3 and Clean. Squad: +2 Armor."}, // cost 4→3 (2026-07-28, по прямому запросу автора — правило "1 тег → cost3"), 1 доп.тег (enter_draw/Valley), статы по формуле Orbiton (HP=cost, ATK=1, heal=3) = 3/1
  t_trvl57_w:  {name:"TRAVELER #57",   cost:4,hp:4,atk:2,art:"👁️", img:"57.png",   f:"tea",tags:["heal:3","untamed","gtype:orb"],        ab:"Active Heal 3 and Clean. Squad: +2 Armor."}, // Orbiton-конверсия (2026-07-28, по прямому запросу автора, подтверждено сверкой с актуальной коллекцией) — эта NFT была допминтом заменена со Szarg на Orbiton, старая запись Szarg-#57 удалена выше (см. секцию Szarg Tea). Трейт при конверсии сменился на Anime/untamed. Остался на cost4 ("на край", т.к. cost3 у Tea Orbiton уже плотно занят — #10/#692/#420/#776/#619), 1 доп.тег, статы по формуле (HP=cost, ATK=1 искл. cost≥4→2, heal=3) = 4/2. Закрывает рострур Orbiton до ровных 32 карт (16 Tea/16 Jeet).
  t_trvl409_w:  {name:"Ilvenne",  cost:1,hp:1,atk:1,art:"👁️", img:"409.png",  f:"tea",tags:["heal:2","gtype:orb"],                  ab:"Active Heal 2 and Clean. Squad: +2 Armor."}, // ИМЕННОЙ путешественник (2026-07-28, по прямому запросу автора) — TRAVELER #409 сожжён из коллекции (ритуал 10 врат), ваниль. Паттерн имён Orbiton — см. CLAUDE.md. cost 4→1 (правило "0 тегов → cost1-2"), статы по формуле (HP=cost, ATK=1, heal=2) = 1/1
  t_trvl596_w:  {name:"Namira",  cost:2,hp:2,atk:1,art:"👁️", img:"596.png",  f:"tea",tags:["heal:2","gtype:orb"],                  ab:"Active Heal 2 and Clean. Squad: +2 Armor."}, // ИМЕННОЙ путешественник (2026-07-28, по прямому запросу автора) — TRAVELER #596 сожжён из коллекции (ритуал 10 врат), ваниль. Паттерн имён Orbiton — см. CLAUDE.md. cost 5→2 (правило "0 тегов → cost1-2, cost5 только на 2 тегах"), статы по формуле (HP=cost, ATK=1, heal=2) = 2/1
  t_trvl465_w:  {name:"TRAVELER #465",  cost:2,hp:2,atk:1,art:"👁️", img:"465.png",  f:"tea",tags:["heal:2","gtype:orb"],                  ab:"Active Heal 2 and Clean. Squad: +2 Armor."}, // cost 5→2 (2026-07-28, по прямому запросу автора — правило "0 тегов → cost1-2, cost5 только на 2 тегах"), ваниль (mood "2", без эффекта), статы по формуле Orbiton (HP=cost, ATK=1, heal=2) = 2/1
  ...
  j_trvl982_w: {name:"TRAVELER #982", cost:1,hp:1,atk:1,art:"👁️", img:"982.png", f:"jeet",tags:["heal:2","gtype:orb"],                  ab:"Active Heal 2 and Clean. Squad: +2 Armor."}, // cost 2→1 (2026-07-28, по прямому запросу автора — правило "0 тегов → cost1-2"), ваниль (mood "Snakes", без эффекта), статы по формуле Orbiton (HP=cost, ATK=1, heal=2) = 1/1
  ...
  j_trvl124_w: {name:"TRAVELER #124", cost:3,hp:3,atk:1,art:"👁️", img:"124.png", f:"jeet",tags:["heal:3","enter_lose:1","gtype:orb"],  ab:"On play Lose 1. Active Heal 3 and Clean. Squad: +2 Armor."}, // cost 4→3 (2026-07-28, по прямому запросу автора — правило "1 тег → cost3"), 1 доп.тег (enter_lose/Net), статы по формуле Orbiton (HP=cost, ATK=1, heal=3) = 3/1
  j_trvl693_w: {name:"TRAVELER #693", cost:4,hp:4,atk:2,art:"👁️", img:"693.png", f:"jeet",tags:["heal:3","untamed","gtype:orb"],       ab:"Active Heal 3 and Clean. Squad: +2 Armor."}, // новая карта (2026-07-28, по прямому запросу автора) — cost4 Orbiton, "на край" т.к. cost3 у Jeet Orbiton уже плотно занят (#454/#523/#568/#213/#124), 1 доп.тег (untamed/Anime); World-трейт "Remember Everything" (remember-тег) с этой же NFT автором в заявке НЕ упомянут — добавлен только untamed, remember НЕ навешан (подтверждено автором, реестр устарел). статы по формуле Orbiton (HP=cost, ATK=1 искл. cost≥4→2, heal=3) = 4/2
  j_trvl967_w: {name:"Oryth",   cost:2,hp:2,atk:1,art:"👁️", img:"967.png", f:"jeet",tags:["heal:2","gtype:orb"],                  ab:"Active Heal 2 and Clean. Squad: +2 Armor."}, // ИМЕННОЙ путешественник (2026-07-28, по прямому запросу автора) — TRAVELER #967 сожжён из коллекции (ритуал 10 врат), ваниль. Паттерн имён Orbiton — см. CLAUDE.md. cost 4→2 (правило "0 тегов → cost1-2"), статы по формуле (HP=cost, ATK=1, heal=2) = 2/1
  j_trvl405_w: {name:"TRAVELER #405", cost:4,hp:4,atk:2,art:"👁️", img:"405.png", f:"jeet",tags:["heal:3","untamed","gtype:orb"],       ab:"Active Heal 3 and Clean. Squad: +2 Armor."}, // cost 5→4 (2026-07-28, по прямому запросу автора — правило "cost5 только на 2 тегах", тут 1 тег), "на край" т.к. cost3 уже плотно занят, 1 доп.тег (untamed/Anime), статы по формуле Orbiton (HP=cost, ATK=1 искл. cost≥4→2, heal=3) = 4/2
  j_trvl478_w: {name:"TRAVELER #478", cost:2,hp:2,atk:1,art:"👁️", img:"478.png", f:"jeet",tags:["heal:2","gtype:orb"],                  ab:"Active Heal 2 and Clean. Squad: +2 Armor."}, // cost 5→2 (2026-07-28, по прямому запросу автора — правило "0 тегов → cost1-2, cost5 только на 2 тегах"), ваниль (mood "6", без эффекта), статы по формуле Orbiton (HP=cost, ATK=1, heal=2) = 2/1
