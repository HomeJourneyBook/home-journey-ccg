...
const DEFS = {
  ...
  // ── TEA SPELLS ──────────────────────────────────────────────────
  t_sp1:       {name:"ARCHIVE",     cost:3,hp:0,atk:0,art:"📜", img:"1_Archive.png", f:"tea",tags:["spell","spell_buff_temp:2"],     ab:"Target ally: +2 ATK until end of battle (survives the opponent's turn too).",spell:true},
  ...
  j_trvl551_w: {name:"TRAVELER #551", cost:2,hp:2,atk:2,art:"🦈", img:"551.png", f:"jeet",tags:["incarnation:4","gtype:szg"],      ab:"Squad: +1 maxHP."},
  ...
  j_mal:       {name:"ABYSSWALKER", cost:5,hp:5,atk:2,art:"🗡️", img:"001_Abysswalker.png", f:"jeet",tags:["unique","armor:1","aura:armor:1"],          ab:"Aura: allies +1 Armor.",unique:true},
