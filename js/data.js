...
const DEFS = {
  ...
  t_sp20:      {name:"EXECUTE",  cost:4,hp:0,atk:0,art:"⚔️", img:"1_Execute.png", f:"tea",tags:["spell","spell_dmg_target:3","draw_on_kill"], ab:"Bolt 3. If this kills the target, draw 1.",spell:true}, // новый спелл (2026-07-24, по прямому запросу автора) — усиленный болт3 с добором при убийстве
  ...
  t_sp22:      {name:"CATACLYSM",  cost:6,hp:0,atk:0,art:"☄️", img:"1_Cataclysm.png", f:"tea",tags:["spell","spell_destroy_all_enemies"], ab:"Destroy all enemy creatures.",spell:true}, // новый спелл (2026-07-24, по прямому запросу автора) — финишная бомба, урон 999 через dmgCard(bypassArmor=true) — Ward/Solana Shield работают как обычно
  ...
  t_sp24:      {name:"RENEWAL", cost:3,hp:0,atk:0,art:"🌀", img:"1_Renewal.png", f:"tea",tags:["spell","spell_refresh_hand:3"], ab:"Discard your hand, then draw 3.",spell:true}, // новый спелл (2026-07-24, по прямому запросу автора) — добавлен в ростер (виден в Rush через getRushPool(), читает DEFS напрямую), НЕ в Classic-колоду — deck.js её вообще не упоминает в хардкоженном списке 'spells', так что SPELL_COPIES тут ни при чём
  ...
  j_sp20:      {name:"CULL",      cost:4,hp:0,atk:0,art:"⚔️", img:"1_Cull.png", f:"jeet",tags:["spell","spell_dmg_target:3","draw_on_kill"], ab:"Bolt 3. If this kills the target, draw 1.",spell:true}, // новый спелл (2026-07-24, по прямому запросу автора)
  ...
  j_sp22:      {name:"EXTINCTION",      cost:6,hp:0,atk:0,art:"☄️", img:"1_Extinction.png", f:"jeet",tags:["spell","spell_destroy_all_enemies"], ab:"Destroy all enemy creatures.",spell:true}, // новый спелл (2026-07-24, по прямому запросу автора)
