...
const DEFS = {
  ...
  t_sp17:      {name:"JAB",  cost:1,hp:0,atk:0,art:"🔪", img:"1_Jab.png", f:"tea",tags:["spell","spell_dmg_target:1"], ab:"Bolt 1.",spell:true}, // новый спелл (2026-07-24, по прямому запросу автора) — дешёвый добивающий болт, реюз готового spell_dmg_target
  t_sp18:      {name:"SCATTERSHOT",  cost:3,hp:0,atk:0,art:"💥", img:"1_Scattershot.png", f:"tea",tags:["spell","spell_random_spread:3"], ab:"3 random damage split across enemy creatures.",spell:true}, // новый спелл (2026-07-24, по прямому запросу автора) — 3 урона случайно на 3 разные цели (2/1 если целей 2, все 3 если цель одна)
  ...
  t_sp25:      {name:"TEMPEST", cost:2,hp:0,atk:0,art:"🌪️", img:"1_Tempest.png", f:"tea",tags:["spell","spell_bounce_target"], ab:"Return 1 target creature (either side) to hand.",spell:true}, // новый спелл (2026-07-24, по прямому запросу автора) — держит СТАРУЮ механику GUST (spell_bounce_target, любая сторона), выделена в отдельную карту при редизайне GUST в ally-only. Только в ростере, не в Classic — если хочешь вернуть "баунс врага" в Classic, нужно решить, что оттуда убрать взамен (сейчас 35/35)
  ...
  j_sp17:      {name:"STING",      cost:1,hp:0,atk:0,art:"🔪", img:"1_Sting.png", f:"jeet",tags:["spell","spell_dmg_target:1"], ab:"Bolt 1.",spell:true}, // новый спелл (2026-07-24, по прямому запросу автора)
  j_sp18:      {name:"SHRAPNEL",      cost:3,hp:0,atk:0,art:"💥", img:"1_Shrapnel.png", f:"jeet",tags:["spell","spell_random_spread:3"], ab:"3 random damage split across enemy creatures.",spell:true}, // новый спелл (2026-07-24, по прямому запросу автора)
  ...
  j_sp25:      {name:"MAELSTROM", cost:2,hp:0,atk:0,art:"🌪️", img:"1_Maelstrom.png", f:"jeet",tags:["spell","spell_bounce_target"], ab:"Return 1 target creature (either side) to hand.",spell:true}, // новый спелл (2026-07-24, по прямому запросу автора) — зеркало TEMPEST (t_sp25)
