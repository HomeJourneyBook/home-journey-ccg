...
const DEFS = {
  ...
  t_trvl434_w:  {name:"TRAVELER #434",  cost:3,hp:2,atk:3,art:"🦈", img:"434.png",  f:"tea",tags:["fear","incarnation:4","gtype:szg"],            ab:"Squad: +1 maxHP."},
  ...
  t_trvl35_w:   {name:"TRAVELER #35",   cost:3,hp:4,atk:3,art:"🤖", img:"35.png",   f:"tea",tags:["pierce","gtype:mch"],                    ab:"Squad: +1 ATK."},
  ...
  t_faeron:    {name:"FAERON",     cost:4,hp:5,atk:2,art:"🔥", img:"010_Faeron.png",   f:"tea",tags:["unique","burn","on_play_creature:1","untamed"], ab:"After each card play: Heal base 1 HP.",unique:true},
  t_nab:       {name:"NABUNAGI",   cost:6,hp:6,atk:2,art:"⛩️", img:"009_Oda.png",     f:"tea",tags:["unique","bushido","armor:1","ward"], ab:"\"Bushido\": ALL attacks must target him. Ward.",unique:true},
  ...
  j_trvl551_w: {name:"TRAVELER #551", cost:3,hp:4,atk:3,art:"🦈", img:"551.png", f:"jeet",tags:["incarnation:4","gtype:szg"],      ab:"Squad: +1 maxHP."},
  ...
  j_trvl454_w: {name:"TRAVELER #454", cost:3,hp:3,atk:2,art:"👁️", img:"454.png", f:"jeet",tags:["heal:1","regen","armor:1","gtype:orb"],           ab:"Active: Heal 1 HP. Squad: Heal 2."},
  ...
  // Umbasir Jeet
    j_trvl550_w:    {name:"TRAVELER #550",  cost:3,hp:3,atk:2,art:"🌀", img:"550.png",  f:"jeet",tags:["bolt:1","fear","gtype:umb"],           ab:"Active: Bolt 1 dmg. Squad: Bolt 2 dmg."},
  ...
  j_trvl804_w:  {name:"TRAVELER #804",  cost:4,hp:4,atk:3,art:"🤖", img:"804.png",  f:"jeet",tags:["pierce","armor:1","regen","gtype:mch"],          ab:"Squad: +1 ATK."},
  ...
  // Xuiqtr Jeet
    ...
    j_trvl972_w:    {name:"TRAVELER #972",  cost:3,hp:3,atk:2,art:"🐙", img:"972.png",  f:"jeet",tags:["provoke","burn","gtype:xui"],          ab:"Squad: +1 ATK."},
     ...
     j_trvl37_w:    {name:"TRAVELER #37",   cost:3,hp:1,atk:2,art:"🐙", img:"37.png",   f:"jeet",tags:["provoke","armor:1","gtype:xui"],                 ab:"Squad: +1 ATK."},
  ...
  j_ryv:       {name:"RYVLEN",      cost:4,hp:5,atk:3,art:"🎭", img:"007_Ryvlen.png",      f:"jeet",tags:["unique","fear","draw_attack:1"],        ab:"On attack: Draw 1 card.",unique:true},
  j_mal:       {name:"ABYSSWALKER", cost:5,hp:5,atk:2,art:"🗡️", img:"001_Abysswalker.png", f:"jeet",tags:["unique","armor:1","aura:armor:1"],          ab:"Aura: +1 Armor.",unique:true},
  j_phleg:     {name:"PHLEGMOR",    cost:6,hp:7,atk:1,art:"💀", img:"005_Phelgmor.png",    f:"jeet",tags:["unique","raise:1","incarnation:2"],                     ab:"On turn: Raise top graveyard card at 1 HP.",unique:true},
  j_vard:      {name:"SEEKER",      cost:4,hp:5,atk:3,art:"🌑", img:"003_Seeker.png",      f:"jeet",tags:["unique","invisible","pierce"],    ab:"\"Seek, and ye shall find.\"",unique:true},
