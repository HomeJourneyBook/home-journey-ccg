...
const DEFS = {
  ...
  t_trvl398_w:  {name:"TRAVELER #398",  cost:3,hp:3,atk:2,art:"👁️", img:"398.png",  f:"tea",tags:["heal:1","vanguard","untamed","gtype:orb"],         ab:"Active: Heal 1 HP. Squad: Heal 2."},
  ...
  t_trvl892_w:  {name:"TRAVELER #892",  cost:3,hp:4,atk:2,art:"🌳", img:"892.png",  f:"tea",tags:["provoke","regen","gtype:drg"],            ab:"Squad: +1 Armor."},
  t_trvl14_w:   {name:"TRAVELER #14",   cost:2,hp:3,atk:1,art:"🌳", img:"14.png",   f:"tea",tags:["provoke","gtype:drg"],                   ab:"Squad: +1 Armor."},

  // Umbasir Tea
    t_trvl583_w:    {name:"TRAVELER #583",  cost:2,hp:2,atk:2,art:"🌀", img:"583.png",  f:"tea",tags:["bolt:1","regen","gtype:umb"],              ab:"Active: Bolt 1 dmg. Squad: Bolt 2 dmg."},
      t_trvl2_w:    {name:"TRAVELER #2",    cost:2,hp:2,atk:2,art:"🌀", img:"2.png",    f:"tea",tags:["bolt:1","untamed","gtype:umb"],                     ab:"Active: Bolt 1 dmg. Squad: Bolt 2 dmg."},
  ...
  // Mechird Tea
  t_trvl38_w:   {name:"TRAVELER #38",   cost:3,hp:2,atk:3,art:"🤖", img:"38.png",   f:"tea",tags:["pierce","rage","gtype:mch"],              ab:"Squad: +1 ATK."},
  ...
  // Xuiqtr Tea
    t_trvl187_w:    {name:"TRAVELER #187",  cost:4,hp:4,atk:4,art:"🐙", img:"187.png",  f:"tea",tags:["provoke","regen","untamed","gtype:xui"],                   ab:"Squad: +1 ATK."},
    t_trvl704_w:    {name:"TRAVELER #704",  cost:4,hp:3,atk:4,art:"🐙", img:"704.png",  f:"tea",tags:["provoke","regen","fear","gtype:xui"],             ab:"Squad: +1 ATK."},
     t_trvl26_w:    {name:"TRAVELER #26",   cost:3,hp:3,atk:3,art:"🐙", img:"26.png",   f:"tea",tags:["provoke","regen","gtype:xui"],            ab:"Squad: +1 ATK."},
     t_trvl39_w:    {name:"TRAVELER #39",   cost:3,hp:3,atk:3,art:"🐙", img:"39.png",   f:"tea",tags:["provoke","regen","gtype:xui"],                   ab:"Squad: +1 ATK."},
  ...
  j_trvl57_w:  {name:"TRAVELER #57",  cost:2,hp:1,atk:3,art:"🦈", img:"57.png",  f:"jeet",tags:["burn","gtype:szg"],           ab:"Squad: +1 maxHP."},
  ...
  j_trvl921_w:  {name:"TRAVELER #921",  cost:3,hp:2,atk:3,art:"🤖", img:"921.png",  f:"jeet",tags:["pierce","burn","gtype:mch"],           ab:"Squad: +1 ATK."},
  j_trvl804_w:  {name:"TRAVELER #804",  cost:3,hp:3,atk:3,art:"🤖", img:"804.png",  f:"jeet",tags:["pierce","regen","gtype:mch"],          ab:"Squad: +1 ATK."},

  // Xuiqtr Jeet
    j_trvl579_w:    {name:"TRAVELER #579",  cost:4,hp:3,atk:4,art:"🐙", img:"579.png",  f:"jeet",tags:["provoke","regen","fear","gtype:xui"],          ab:"Squad: +1 ATK."},
    j_trvl972_w:    {name:"TRAVELER #972",  cost:4,hp:3,atk:4,art:"🐙", img:"972.png",  f:"jeet",tags:["provoke","regen","burn","gtype:xui"],          ab:"Squad: +1 ATK."},
     j_trvl50_w:    {name:"TRAVELER #50",   cost:3,hp:3,atk:3,art:"🐙", img:"50.png",   f:"jeet",tags:["provoke","regen","gtype:xui"],                 ab:"Squad: +1 ATK."},
     j_trvl37_w:    {name:"TRAVELER #37",   cost:3,hp:3,atk:3,art:"🐙", img:"37.png",   f:"jeet",tags:["provoke","regen","gtype:xui"],                 ab:"Squad: +1 ATK."},
