...
const DEFS = {
  ...
  t_trvl295_w:   {name:"TRAVELER #295",   cost:5,hp:5,atk:5,art:"🤖", img:"295.png",   f:"tea",tags:["pierce","burn","rage","gtype:mch"],                    ab:"Squad +1 ATK."}, // новая карта (2026-07-24, по прямому запросу автора) — cost5 Mechird, 2 доп.тега (burn+vampiric), статы по образцу пира #128 (cost5, 2 доп.тега = hp5/atk4)
