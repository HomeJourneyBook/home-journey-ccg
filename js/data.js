...
const DEFS = {
  ...
  t_trvl250_w: {name:"TRAVELER #250", cost:5,hp:5,atk:6,art:"🦈", img:"250.png",  f:"tea",tags:["burn","death_bolt:4","gtype:szg"],            ab:"Squad +1 maxHP."}, // новая карта (2026-07-27, по прямому запросу автора) — cost5 Szarg, 2 доп.тега (burn/Flame + death_bolt/Pink Clouds), статы по формуле Szarg (HP=cost, ATK=cost+1, без исключений) = 5/6. ⚠️ см. заметку в CLAUDE.md "cost5 Szarg — решение отложено": формула на cost5 с двумя дорогими тегами ранее считалась потенциально перегретой (WWP 58-60% по симуляции) — не проверено повторно на ЭТОЙ конкретной карте, статы взяты по формуле как есть, автор проверит на плейтесте
  ...
  j_trvl454_w: {name:"TRAVELER #454", cost:3,hp:3,atk:1,art:"👁️", img:"454.png", f:"jeet",tags:["heal:3","regen","gtype:orb"],           ab:"Active Heal 3 and Clean. Squad: +2 Armor."}, // ATK 2→1 (2026-07-27, откат формулы Orbiton, см. #10)
  j_trvl523_w: {name:"TRAVELER #523", cost:3,hp:3,atk:1,art:"👁️", img:"523.png", f:"jeet",tags:["heal:3","fear","gtype:orb"],            ab:"Active Heal 3 and Clean. Squad: +2 Armor."}, // ATK 2→1 (2026-07-27, откат формулы Orbiton, см. #10)
