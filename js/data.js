...
const DEFS = {
  ...
  t_trvl56_w: {name:"TRAVELER #56", cost:4,hp:4,atk:5,art:"🦈", img:"56.png",  f:"tea",tags:["scheme","gtype:szg"],            ab:"Squad +1 maxHP."}, // taunt_break→scheme (2026-07-26, по прямому запросу автора). ATK 4→5 (2026-07-24, по прямому запросу автора)
  ...
  t_trvl699_w:   {name:"TRAVELER #699",   cost:4,hp:4,atk:4,art:"🤖", img:"699.png",   f:"tea",tags:["pierce","scheme","untamed","gtype:mch"],                    ab:"Squad +1 ATK."}, // новая карта (2026-07-24, по прямому запросу автора) — cost4 Mechird, 2 доп.тега (taunt_break+untamed), статы по образцу пиров #663/#320 (cost4, 2 доп.тега = hp4/atk3). taunt_break→scheme (2026-07-26, по прямому запросу автора)
  ...
  t_trvl847_w:    {name:"TRAVELER #847",  cost:4,hp:6,atk:3,art:"🐙", img:"847.png",  f:"tea",tags:["intercept","ward","gtype:xui"],                   ab:"Squad +1 ATK."}, // новая карта (2026-07-24, по прямому запросу автора) — cost4 Xuiqtr, 1 доп.тег (ward); прямого 1-тегового пира на cost4 нет, статы взяты по уровню 2-теговых cost4 пиров (#806, было #402 до переноса) — hp6/atk2, не проверено симуляцией
     t_trvl26_w:    {name:"TRAVELER #26",   cost:3,hp:5,atk:2,art:"🐙", img:"26.png",   f:"tea",tags:["intercept","scheme","gtype:xui"],            ab:"Squad +1 ATK."}, // taunt_break→scheme (2026-07-26, по прямому запросу автора)
  ...
  // Umbasir Jeet (HP ребаланс 2026-07-20 — см. комментарий у Orbiton Tea выше)
    j_trvl550_w:    {name:"TRAVELER #550",  cost:4,hp:4,atk:2,art:"🌀", img:"550.png",  f:"jeet",tags:["bolt:1","fear","scheme","gtype:umb"],           ab:"Active Bolt 1. Squad Bolt 2."}, // taunt_break→scheme (2026-07-26, по прямому запросу автора)
