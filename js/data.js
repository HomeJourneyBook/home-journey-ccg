...
const DEFS = {
  ...
  t_sp26:      {name:"JUDGMENT", cost:2,hp:0,atk:0,art:"⚖️", img:"1_Judgment.png", f:"tea",tags:["spell","spell_execute_half"], ab:"Destroy target enemy creature at half HP or less.",spell:true}, // новый спелл (2026-07-24, по прямому запросу автора) — условный дешёвый килл (HS-style "execute"), первая карта такого типа в игре — только в ростере
  ...
  j_sp26:      {name:"DEATHBLOW", cost:2,hp:0,atk:0,art:"⚖️", img:"1_Deathblow.png", f:"jeet",tags:["spell","spell_execute_half"], ab:"Destroy target enemy creature at half HP or less.",spell:true}, // новый спелл (2026-07-24, по прямому запросу автора) — зеркало JUDGMENT (t_sp26)
