...
const DEFS = {
  ...
  // Orbiton Tea
  t_trvl10_w:   {name:"TRAVELER #10",   cost:2,hp:3,atk:1,art:"👁️", img:"10.png",   f:"tea",tags:["heal:2","burn","gtype:orb"],             ab:"Active: Heal 2 HP. Squad: Heal 4."},
  t_trvl398_w:  {name:"TRAVELER #398",  cost:3,hp:7,atk:1,art:"👁️", img:"398.png",  f:"tea",tags:["heal:2","vanguard","untamed","armor:1","gtype:orb"],         ab:"Active: Heal 2 HP. Squad: Heal 4."},
  ...
  // Dreegan Tea
  t_trvl1_w:    {name:"TRAVELER #1",    cost:3,hp:7,atk:1,art:"🌳", img:"1.png",    f:"tea",tags:["provoke","enter_heal:2","gtype:drg"],                   ab:"On play: Heal 2 HP to wounded allies. Squad: +1 Armor."},
  ...
  // Umbasir Tea
    t_trvl583_w:    {name:"TRAVELER #583",  cost:3,hp:5,atk:2,art:"🌀", img:"583.png",  f:"tea",tags:["bolt:1","regen","enter_heal:2","gtype:umb"],              ab:"On play: Heal 2 HP to wounded allies. Active: Bolt 1 dmg. Squad: Bolt 2 dmg."},
      t_trvl2_w:    {name:"TRAVELER #2",    cost:2,hp:3,atk:1,art:"🌀", img:"2.png",    f:"tea",tags:["bolt:1","untamed","gtype:umb"],                     ab:"Active: Bolt 1 dmg. Squad: Bolt 2 dmg."},
  ...
  j_trvl454_w: {name:"TRAVELER #454", cost:3,hp:6,atk:1,art:"👁️", img:"454.png", f:"jeet",tags:["heal:2","regen","armor:1","gtype:orb"],           ab:"Active: Heal 2 HP. Squad: Heal 4."},
  j_trvl523_w: {name:"TRAVELER #523", cost:2,hp:3,atk:1,art:"👁️", img:"523.png", f:"jeet",tags:["heal:2","fear","gtype:orb"],            ab:"Active: Heal 2 HP. Squad: Heal 4."},
  ...
  // Umbasir Jeet
    j_trvl550_w:    {name:"TRAVELER #550",  cost:4,hp:7,atk:1,art:"🌀", img:"550.png",  f:"jeet",tags:["bolt:1","fear","taunt_break","gtype:umb"],           ab:"Active: Bolt 1 dmg. Squad: Bolt 2 dmg."},
     j_trvl53_w:    {name:"TRAVELER #53",   cost:2,hp:2,atk:1,art:"🌀", img:"53.png",   f:"jeet",tags:["bolt:1","invisible","gtype:umb"],                  ab:"Active: Bolt 1 dmg. Squad: Bolt 2 dmg."},
     ...
     j_trvl20_w:    {name:"TRAVELER #20",   cost:3,hp:5,atk:1,art:"🌀", img:"20.png",   f:"jeet",tags:["bolt:1","vanguard","untamed","gtype:umb"],        ab:"Active: Bolt 1 dmg. Squad: Bolt 2 dmg."},
